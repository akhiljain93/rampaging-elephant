# Controller for data.html; web2py appadmin with authentication and database update option disabled
...
def select():
    ...
    form = FORM(TABLE(TR(T('Query:'), '', INPUT(_style='width:400px', _name='query', _value=request.vars.query or '')), 
