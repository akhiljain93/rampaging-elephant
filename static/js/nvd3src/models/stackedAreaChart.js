...
nv.models.stackedAreaChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      gEnter.append('g').attr('class', 'y axis').attr("transform","translate(0,-250)");
      gEnter.append('g').attr('class', 'stackedWrap').attr("transform","translate(0,-250)");
      ...
      if (showLegend) {
        ...
        g.select('.legendWrap').style("clear","both")
            .attr('transform', 'translate(' + -3 + ',' + (430-margin.top+25) +')');
      }
      ...
      g.select('.x.axis')
          .attr('transform', 'translate(0,' + (availableHeight-250) + ')');
      ...
      stacked.dispatch.on('tooltipShow', function(e) {
        ...
        e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top-120],
